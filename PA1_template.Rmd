...
Measure | Result
--------|---------------------------------------
Mean    | `r formatC(mean(stepsperday$steps, na.rm=TRUE))`
...
Measure | Result
--------|---------------------------------------
Mean    | `r formatC(mean(stepsperday_filled$steps),format ="d")`
Median  | `r formatC(median(stepsperday_filled$steps),format ="d")`
...
--------|------------------------|-----------------------------------
Mean    |  `r formatC(mean(stepsperday$steps, na.rm=TRUE))`|`r formatC(mean(stepsperday_filled$steps),format ="d")`
Median  | `r median(stepsperday$steps, na.rm=TRUE)`|`r formatC(median(stepsperday_filled$steps),format ="d")`
